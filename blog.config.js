...
const BLOG = {
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'http://twikoo.asenkits.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  SEO_BAIDU_SITE_VERIFICATION:
      process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || '<BLOG.SEO_BAIDU_SITE_VERIFICATION>', // Remove the value or replace it with your own google site verification code
    <meta name="baidu-site-verification" content="codeva-hxbI45M20e" />
